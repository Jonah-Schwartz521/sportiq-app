...
def list_predictions(
    ...
    """
    - If called exactly as `/predictions` (no query params), return a raw list (legacy behavior for tests).
    - If any query param is present (e.g., limit/offset), return a paginated envelope: { items, total_returned, limit, offset }.
    """
    sql = """
